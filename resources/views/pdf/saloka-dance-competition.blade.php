        ...
        <tr>
          <td align="left"
            ...
            <h6 style="line-height: 1.2; font-size: 14px">
              <strong>Dance Competition Saloka 2026</strong>
            </h6>
              ...
              <tbody>
                ...
                <tr>
                  <td style="font-size:12px; line-height:1.5;">
                    <p><strong>1.</strong> Terbuka untuk umum.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="font-size:12px; line-height:1.5;">
                    <p><strong>6.</strong> Setiap kontingen boleh mengirimkan lebih dari 1 tim.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="font-size:12px; line-height:1.5;">
                    <p><strong>10.</strong> Peserta harus standby 30 menit sebelum jadwal tampil di area lomba.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="font-size:12px; line-height:1.5;">
                    <p><strong>20.</strong> Peserta dihimbau untuk membawa tumbler atau botol minum.</p>
                  </td>
                </tr>
