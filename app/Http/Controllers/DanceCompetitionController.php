...
class DanceCompetitionController extends Controller
{
    ...
    public function GeneratePdf(Request $request)
    {
        ...
        try {
            ...
            $pdfTicket = Pdf::loadView('pdf.saloka-dance-competition', $data)
    ...
    public function GenerateSertificate(Request $request)
    {
        ...
        try {
            ...
            $pdf = Pdf::loadView(
                'pdf.sertificate-dance-competition',
                $data
            )
            ...
            $path = 'e-certificates/dance-competition/' . $fileName;
